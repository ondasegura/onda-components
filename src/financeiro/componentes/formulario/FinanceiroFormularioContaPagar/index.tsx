...
import controller_conta_pagar from "../../../controllers/contas_pagar";

const FormularioFinanceiroContaPagar: React.FC = () => {
                ...
                <div className="flex flex-col h-full">
                    <div className="flex items-center justify-between p-6 border-b border-gray-200">
                        ...
                        <button
                            type="button"
                            onClick={handleClose}
                            disabled={formulario.loading || isSubmitting}
...
export default FormularioFinanceiroContaPagar;
